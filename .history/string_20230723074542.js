...
console.log(newStr.split("name", 50)); // Tách ra xoá bỏ nội dung truyền vào trả về mảng có nội dung còn lại
console.log(newStr.slice(1, 15)); // Lấy ra nội dung ở từ vị trí 1 đến 15
console.log(newStr.substring(2, 10)); // trả 1 string có nội dung từ 2 đến 10
console.log(newStr.toLocaleLowerCase("m"));
