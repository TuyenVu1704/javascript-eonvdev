...
const number = "5";
console.log(number.padEnd(4, "0")); // Trẩ về tối đa số lượng ký tự là 4 và gán thêm 0 và sau
console.log(number.padStart(4, "0")); // Trẩ về tối đa số lượng ký tự là 4 và gán thêm 0 và sau
